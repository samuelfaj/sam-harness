...
func Run(path string) (Report, error) {
	...
	requiredDocuments := map[string][]string{
		"AGENTS.md":                              {"<!-- sam-harness:start -->", "<!-- sam-harness:end -->", "unify redundant host CI", model.DeliveryHappyPath, model.DeliveryExceptionPath},
		...
		".sam-harness/WORKFLOW.md":               {"# Executable workflow", "## Delivery graph", model.DeliveryHappyPath, model.DeliveryExceptionPath, "## Unify redundant CI", "Prefer generated"},
		".sam-harness/GATES.md":                  {"# Gates", "## CI unification", model.DeliveryHappyPath, model.DeliveryExceptionPath},
	...
	if cfg.CI.Managed {
		for _, provider := range cfg.CI.Providers {
			...
			switch provider {
			case "github":
				fragments := []string{"# Generated by sam-harness", model.DeliveryHappyPath, model.DeliveryExceptionPath, "merge_group:", "permissions:\n  contents: read", "  static:", "  test:"}
				if cfg.Workflow != nil && cfg.Workflow.Enabled {
			...
			case "gitlab":
				fragments := []string{"# Generated by sam-harness", model.DeliveryHappyPath, model.DeliveryExceptionPath, "sam-harness-static:", "sam-harness-test:"}
				if cfg.Workflow != nil && cfg.Workflow.Enabled {
